...
return [
    ...
    */
    ...
    'attributes' => [
        'findings_chestabdomen'=>	'胸部腹部所見',
        'height'=>	'身長',
        'weight'=>	'体重',
        'abdominal_circumference'=>	'腹囲',
        'bodyfat_ratio'=>	'体脂肪率',
        'r_eyesight'=>	'裸眼右',
        'l_eyesight'=>	'裸眼左',
        'corrected_r_eyesight'=>	'矯正右',
        'corrected_l_eyesight'=>	'矯正左',
        'r_hearing_1000hz'=>	'聴力右1KHz',
        'l_hearing_1000hz'=>	'聴力左1KHz',
        'r_hearing_4000hz'=>	'聴力右4KHz',
        'l_hearing_4000hz'=>	'聴力左4KHz',
        'hearing_on_conv'=>	'聴力会話法',
        'h_blood_pressure'=>	'収縮期血圧',
        'l_blood_pressure'=>	'拡張期血圧',
        'chest_xray_no'=>	'胸部X線番号',
        'electro_no'=>	'心電図番号',
        
        'vision_test'=>	'視力',
        'hearing_test'=>	'聴力オージオ',
        'hearing_test_conv'=>	'聴力会話法',
        'physical_examination'=>	'診察',
        'blood_pressure'=>	'血圧',
        'fecaloccult_blood'=>	'便潜血',
        'chest_xray'=>	'胸部X線',
        'electrogram_test'=>	'心電図',
        'urinary_test'=>	'尿検査',
        'urinary_test_type'=>	'尿検査タイプ',
        'urinary_sediment'=>	'尿沈渣',
        'blood_test'=>	'血液検査',
        'blood_test_type'=>	'血液検査タイプ',
